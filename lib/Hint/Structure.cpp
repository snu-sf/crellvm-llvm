...
static std::string toString(enum hintgen::structure::instr_type instrType) {
  switch (instrType) {
    case hintgen::structure::Command:
      return std::string("Command");
    case hintgen::structure::Phinode:
      return std::string("Phinode");
    case hintgen::structure::Terminal:
...
static std::string toString(enum hintgen::structure::scope scope) {
  switch (scope) {
    case hintgen::structure::Source:
      return std::string("Source");
    case hintgen::structure::Target:
...
hints::hints(std::string _function_id, std::string _module_id, std::string _opt_name):
