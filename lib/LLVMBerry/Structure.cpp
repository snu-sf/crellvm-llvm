...
namespace llvmberry {
  ...
  TyConstInt::TyConstInt(int _int_value, bool _signed_flag, int _value)
    : int_value(_int_value), int_type(new ConsIntType(_signed_flag, _value)) { }
  ...
  ConsConstInt::ConsConstInt(int _int_value, bool _signed_flag, int _value)
    : const_int(new TyConstInt(_int_value, _signed_flag, _value)) { }
  ...
  ConsConst::ConsConst(int _int_value, bool _signed_flag, int _value)
    : constant(new ConsConstInt(_int_value, _signed_flag, _value)) { }
