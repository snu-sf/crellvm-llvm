...
TyBitcastBitcast::TyBitcastBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastBitcast::ConsBitcastBitcast(std::shared_ptr<TyBitcastBitcast> _bitcast_bitcast) : bitcast_bitcast(_bitcast_bitcast){
}
std::shared_ptr<TyInfrule> ConsBitcastBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastBitcast> _val(new TyBitcastBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastFpext::TyBitcastFpext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastFpext::ConsBitcastFpext(std::shared_ptr<TyBitcastFpext> _bitcast_fpext) : bitcast_fpext(_bitcast_fpext){
}
std::shared_ptr<TyInfrule> ConsBitcastFpext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastFpext> _val(new TyBitcastFpext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastFptosi::TyBitcastFptosi(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastFptosi::ConsBitcastFptosi(std::shared_ptr<TyBitcastFptosi> _bitcast_fptosi) : bitcast_fptosi(_bitcast_fptosi){
}
std::shared_ptr<TyInfrule> ConsBitcastFptosi::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastFptosi> _val(new TyBitcastFptosi(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastFptoui::TyBitcastFptoui(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastFptoui::ConsBitcastFptoui(std::shared_ptr<TyBitcastFptoui> _bitcast_fptoui) : bitcast_fptoui(_bitcast_fptoui){
}
std::shared_ptr<TyInfrule> ConsBitcastFptoui::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastFptoui> _val(new TyBitcastFptoui(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastFptrunc::TyBitcastFptrunc(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastFptrunc::ConsBitcastFptrunc(std::shared_ptr<TyBitcastFptrunc> _bitcast_fptrunc) : bitcast_fptrunc(_bitcast_fptrunc){
}
std::shared_ptr<TyInfrule> ConsBitcastFptrunc::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastFptrunc> _val(new TyBitcastFptrunc(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastInttoptr::TyBitcastInttoptr(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastInttoptr::ConsBitcastInttoptr(std::shared_ptr<TyBitcastInttoptr> _bitcast_inttoptr) : bitcast_inttoptr(_bitcast_inttoptr){
}
std::shared_ptr<TyInfrule> ConsBitcastInttoptr::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastInttoptr> _val(new TyBitcastInttoptr(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsBitcastPtrtoint::ConsBitcastPtrtoint(std::shared_ptr<TyBitcastPtrtoint> _bitcast_ptrtoint) : bitcast_ptrtoint(_bitcast_ptrtoint){
}
std::shared_ptr<TyInfrule> ConsBitcastPtrtoint::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastPtrtoint> _val(new TyBitcastPtrtoint(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastSext::TyBitcastSext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastSext::ConsBitcastSext(std::shared_ptr<TyBitcastSext> _bitcast_sext) : bitcast_sext(_bitcast_sext){
}
std::shared_ptr<TyInfrule> ConsBitcastSext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastSext> _val(new TyBitcastSext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastSametype::TyBitcastSametype(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _tty) : src(_src), dst(_dst), tty(_tty){
}
...
ConsBitcastSametype::ConsBitcastSametype(std::shared_ptr<TyBitcastSametype> _bitcast_sametype) : bitcast_sametype(_bitcast_sametype){
}
std::shared_ptr<TyInfrule> ConsBitcastSametype::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _tty){
  std::shared_ptr<TyBitcastSametype> _val(new TyBitcastSametype(_src, _dst, _tty));
...
TyBitcastSitofp::TyBitcastSitofp(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastSitofp::ConsBitcastSitofp(std::shared_ptr<TyBitcastSitofp> _bitcast_sitofp) : bitcast_sitofp(_bitcast_sitofp){
}
std::shared_ptr<TyInfrule> ConsBitcastSitofp::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastSitofp> _val(new TyBitcastSitofp(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastTrunc::TyBitcastTrunc(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastTrunc::ConsBitcastTrunc(std::shared_ptr<TyBitcastTrunc> _bitcast_trunc) : bitcast_trunc(_bitcast_trunc){
}
std::shared_ptr<TyInfrule> ConsBitcastTrunc::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastTrunc> _val(new TyBitcastTrunc(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastUitofp::TyBitcastUitofp(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastUitofp::ConsBitcastUitofp(std::shared_ptr<TyBitcastUitofp> _bitcast_uitofp) : bitcast_uitofp(_bitcast_uitofp){
}
std::shared_ptr<TyInfrule> ConsBitcastUitofp::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastUitofp> _val(new TyBitcastUitofp(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyBitcastZext::TyBitcastZext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsBitcastZext::ConsBitcastZext(std::shared_ptr<TyBitcastZext> _bitcast_zext) : bitcast_zext(_bitcast_zext){
}
std::shared_ptr<TyInfrule> ConsBitcastZext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyBitcastZext> _val(new TyBitcastZext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsAndMone::ConsAndMone(std::shared_ptr<TyAndMone> _and_mone) : and_mone(std::move(_and_mone)){
}
std::shared_ptr<TyInfrule> ConsAndMone::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyAndMone> _val(new TyAndMone(std::move(_z), std::move(_x), std::move(_sz)));
...
TyAndNot::TyAndNot(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), y(std::move(_y)), sz(std::move(_sz)){
}
...
ConsAndNot::ConsAndNot(std::shared_ptr<TyAndNot> _and_not) : and_not(std::move(_and_not)){
}
std::shared_ptr<TyInfrule> ConsAndNot::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyAndNot> _val(new TyAndNot(std::move(_z), std::move(_x), std::move(_y), std::move(_sz)));
...
TyAndOr::TyAndOr(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), y(std::move(_y)), a(std::move(_a)), sz(std::move(_sz)){
}
...
ConsAndOr::ConsAndOr(std::shared_ptr<TyAndOr> _and_or) : and_or(std::move(_and_or)){
}
std::shared_ptr<TyInfrule> ConsAndOr::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyAndOr> _val(new TyAndOr(std::move(_z), std::move(_x), std::move(_y), std::move(_a), std::move(_sz)));
...
TyAndSame::TyAndSame(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), sz(std::move(_sz)){
}
...
ConsAndSame::ConsAndSame(std::shared_ptr<TyAndSame> _and_same) : and_same(std::move(_and_same)){
}
std::shared_ptr<TyInfrule> ConsAndSame::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyAndSame> _val(new TyAndSame(std::move(_z), std::move(_x), std::move(_sz)));
...
TyAndUndef::TyAndUndef(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), sz(std::move(_sz)){
}
...
ConsAndUndef::ConsAndUndef(std::shared_ptr<TyAndUndef> _and_undef) : and_undef(std::move(_and_undef)){
}
std::shared_ptr<TyInfrule> ConsAndUndef::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyAndUndef> _val(new TyAndUndef(std::move(_z), std::move(_x), std::move(_sz)));
...
TyAndZero::TyAndZero(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), sz(std::move(_sz)){
}
...
ConsAndZero::ConsAndZero(std::shared_ptr<TyAndZero> _and_zero) : and_zero(std::move(_and_zero)){
}
std::shared_ptr<TyInfrule> ConsAndZero::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyAndZero> _val(new TyAndZero(std::move(_z), std::move(_x), std::move(_sz)));
...
TyFptruncBitcast::TyFptruncBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsFptruncBitcast::ConsFptruncBitcast(std::shared_ptr<TyFptruncBitcast> _fptrunc_bitcast) : fptrunc_bitcast(_fptrunc_bitcast){
}
std::shared_ptr<TyInfrule> ConsFptruncBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyFptruncBitcast> _val(new TyFptruncBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyFptruncFpext::TyFptruncFpext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsFptruncFpext::ConsFptruncFpext(std::shared_ptr<TyFptruncFpext> _fptrunc_fpext) : fptrunc_fpext(_fptrunc_fpext){
}
std::shared_ptr<TyInfrule> ConsFptruncFpext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyFptruncFpext> _val(new TyFptruncFpext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyFpextBitcast::TyFpextBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsFpextBitcast::ConsFpextBitcast(std::shared_ptr<TyFpextBitcast> _fpext_bitcast) : fpext_bitcast(_fpext_bitcast){
}
std::shared_ptr<TyInfrule> ConsFpextBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyFpextBitcast> _val(new TyFpextBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyFpextFpext::TyFpextFpext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsFpextFpext::ConsFpextFpext(std::shared_ptr<TyFpextFpext> _fpext_fpext) : fpext_fpext(_fpext_fpext){
}
std::shared_ptr<TyInfrule> ConsFpextFpext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyFpextFpext> _val(new TyFpextFpext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyFptosiBitcast::TyFptosiBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsFptosiBitcast::ConsFptosiBitcast(std::shared_ptr<TyFptosiBitcast> _fptosi_bitcast) : fptosi_bitcast(_fptosi_bitcast){
}
std::shared_ptr<TyInfrule> ConsFptosiBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyFptosiBitcast> _val(new TyFptosiBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyFptosiFpext::TyFptosiFpext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsFptosiFpext::ConsFptosiFpext(std::shared_ptr<TyFptosiFpext> _fpext_fptosi) : fpext_fptosi(_fpext_fptosi){
}
std::shared_ptr<TyInfrule> ConsFptosiFpext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyFptosiFpext> _val(new TyFptosiFpext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyFptouiBitcast::TyFptouiBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsFptouiBitcast::ConsFptouiBitcast(std::shared_ptr<TyFptouiBitcast> _fptoui_bitcast) : fptoui_bitcast(_fptoui_bitcast){
}
std::shared_ptr<TyInfrule> ConsFptouiBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyFptouiBitcast> _val(new TyFptouiBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyFptouiFpext::TyFptouiFpext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsFptouiFpext::ConsFptouiFpext(std::shared_ptr<TyFptouiFpext> _fpext_fptoui) : fpext_fptoui(_fpext_fptoui){
}
std::shared_ptr<TyInfrule> ConsFptouiFpext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyFptouiFpext> _val(new TyFptouiFpext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyPtrtointBitcast::TyPtrtointBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsPtrtointBitcast::ConsPtrtointBitcast(std::shared_ptr<TyPtrtointBitcast> _inttoptr_bitcast) : inttoptr_bitcast(_inttoptr_bitcast){
}
std::shared_ptr<TyInfrule> ConsPtrtointBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyPtrtointBitcast> _val(new TyPtrtointBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsLessthanUndef::ConsLessthanUndef(std::shared_ptr<TyLessthanUndef> _lessthan_undef) : lessthan_undef(std::move(_lessthan_undef)){
}
std::shared_ptr<TyInfrule> ConsLessthanUndef::make(std::shared_ptr<TyValueType> _ty, std::shared_ptr<TyValue> _v){
  std::shared_ptr<TyLessthanUndef> _val(new TyLessthanUndef(std::move(_ty), std::move(_v)));
...
TyOrAnd::TyOrAnd(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz) : z(std::move(_z)), y(std::move(_y)), x(std::move(_x)), a(std::move(_a)), sz(std::move(_sz)){
}
...
ConsOrAnd::ConsOrAnd(std::shared_ptr<TyOrAnd> _or_and) : or_and(std::move(_or_and)){
}
std::shared_ptr<TyInfrule> ConsOrAnd::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrAnd> _val(new TyOrAnd(std::move(_z), std::move(_y), std::move(_x), std::move(_a), std::move(_sz)));
...
TyOrAndXor::TyOrAndXor(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _a, std::shared_ptr<TyValue> _b, std::shared_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), y(std::move(_y)), a(std::move(_a)), b(std::move(_b)), sz(std::move(_sz)){
}
...
ConsOrAndXor::ConsOrAndXor(std::shared_ptr<TyOrAndXor> _or_and_xor) : or_and_xor(std::move(_or_and_xor)){
}
std::shared_ptr<TyInfrule> ConsOrAndXor::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _a, std::shared_ptr<TyValue> _b, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrAndXor> _val(new TyOrAndXor(std::move(_z), std::move(_x), std::move(_y), std::move(_a), std::move(_b), std::move(_sz)));
...
TyOrCommutativeTgt::TyOrCommutativeTgt(std::shared_ptr<TyRegister> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), y(std::move(_y)), sz(std::move(_sz)){
}
...
ConsOrCommutativeTgt::ConsOrCommutativeTgt(std::shared_ptr<TyOrCommutativeTgt> _or_commutative_tgt) : or_commutative_tgt(std::move(_or_commutative_tgt)){
}
std::shared_ptr<TyInfrule> ConsOrCommutativeTgt::make(std::shared_ptr<TyRegister> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrCommutativeTgt> _val(new TyOrCommutativeTgt(std::move(_z), std::move(_x), std::move(_y), std::move(_sz)));
...
TyOrMone::TyOrMone(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz) : z(std::move(_z)), a(std::move(_a)), sz(std::move(_sz)){
}
...
ConsOrMone::ConsOrMone(std::shared_ptr<TyOrMone> _or_mone) : or_mone(std::move(_or_mone)){
}
std::shared_ptr<TyInfrule> ConsOrMone::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrMone> _val(new TyOrMone(std::move(_z), std::move(_a), std::move(_sz)));
...
TyOrNot::TyOrNot(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz) : z(std::move(_z)), y(std::move(_y)), x(std::move(_x)), sz(std::move(_sz)){
}
...
ConsOrNot::ConsOrNot(std::shared_ptr<TyOrNot> _or_not) : or_not(std::move(_or_not)){
}
std::shared_ptr<TyInfrule> ConsOrNot::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _x, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrNot> _val(new TyOrNot(std::move(_z), std::move(_y), std::move(_x), std::move(_sz)));
...
TyOrUndef::TyOrUndef(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz) : z(std::move(_z)), a(std::move(_a)), sz(std::move(_sz)){
}
...
ConsOrUndef::ConsOrUndef(std::shared_ptr<TyOrUndef> _or_undef) : or_undef(std::move(_or_undef)){
}
std::shared_ptr<TyInfrule> ConsOrUndef::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrUndef> _val(new TyOrUndef(std::move(_z), std::move(_a), std::move(_sz)));
...
TyOrSame::TyOrSame(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz) : z(std::move(_z)), a(std::move(_a)), sz(std::move(_sz)){
}
...
ConsOrSame::ConsOrSame(std::shared_ptr<TyOrSame> _or_same) : or_same(std::move(_or_same)){
}
std::shared_ptr<TyInfrule> ConsOrSame::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrSame> _val(new TyOrSame(std::move(_z), std::move(_a), std::move(_sz)));
...
TyOrXor3::TyOrXor3(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _a, std::shared_ptr<TyValue> _b, std::shared_ptr<TySize> _sz) : z(std::move(_z)), y(std::move(_y)), a(std::move(_a)), b(std::move(_b)), sz(std::move(_sz)){
}
...
ConsOrXor3::ConsOrXor3(std::shared_ptr<TyOrXor3> _or_xor3) : or_xor3(std::move(_or_xor3)){
}
std::shared_ptr<TyInfrule> ConsOrXor3::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _a, std::shared_ptr<TyValue> _b, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrXor3> _val(new TyOrXor3(std::move(_z), std::move(_y), std::move(_a), std::move(_b), std::move(_sz)));
...
TyOrXor4::TyOrXor4(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _a, std::shared_ptr<TyValue> _b, std::shared_ptr<TyValue> _nb, std::shared_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), y(std::move(_y)), a(std::move(_a)), b(std::move(_b)), nb(std::move(_nb)), sz(std::move(_sz)){
}
...
ConsOrXor4::ConsOrXor4(std::shared_ptr<TyOrXor4> _or_xor4) : or_xor4(std::move(_or_xor4)){
}
std::shared_ptr<TyInfrule> ConsOrXor4::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _x, std::shared_ptr<TyValue> _y, std::shared_ptr<TyValue> _a, std::shared_ptr<TyValue> _b, std::shared_ptr<TyValue> _nb, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrXor4> _val(new TyOrXor4(std::move(_z), std::move(_x), std::move(_y), std::move(_a), std::move(_b), std::move(_nb), std::move(_sz)));
...
TyOrZero::TyOrZero(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz) : z(std::move(_z)), a(std::move(_a)), sz(std::move(_sz)){
}
...
ConsOrZero::ConsOrZero(std::shared_ptr<TyOrZero> _or_zero) : or_zero(std::move(_or_zero)){
}
std::shared_ptr<TyInfrule> ConsOrZero::make(std::shared_ptr<TyValue> _z, std::shared_ptr<TyValue> _a, std::shared_ptr<TySize> _sz){
  std::shared_ptr<TyOrZero> _val(new TyOrZero(std::move(_z), std::move(_a), std::move(_sz)));
...
TyTruncBitcast::TyTruncBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsTruncBitcast::ConsTruncBitcast(std::shared_ptr<TyTruncBitcast> _trunc_bitcast) : trunc_bitcast(_trunc_bitcast){
}
std::shared_ptr<TyInfrule> ConsTruncBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyTruncBitcast> _val(new TyTruncBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsTruncPtrtoint::ConsTruncPtrtoint(std::shared_ptr<TyTruncPtrtoint> _ptrtoint_trunc) : ptrtoint_trunc(_ptrtoint_trunc){
}
std::shared_ptr<TyInfrule> ConsTruncPtrtoint::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyTruncPtrtoint> _val(new TyTruncPtrtoint(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsSextBitcast::ConsSextBitcast(std::shared_ptr<TySextBitcast> _sext_bitcast) : sext_bitcast(_sext_bitcast){
}
std::shared_ptr<TyInfrule> ConsSextBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TySextBitcast> _val(new TySextBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TySextSext::TySextSext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsSextSext::ConsSextSext(std::shared_ptr<TySextSext> _sext_sext) : sext_sext(_sext_sext){
}
std::shared_ptr<TyInfrule> ConsSextSext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TySextSext> _val(new TySextSext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TySitofpBitcast::TySitofpBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsSitofpBitcast::ConsSitofpBitcast(std::shared_ptr<TySitofpBitcast> _sitofp_bitcast) : sitofp_bitcast(_sitofp_bitcast){
}
std::shared_ptr<TyInfrule> ConsSitofpBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TySitofpBitcast> _val(new TySitofpBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TySitofpSext::TySitofpSext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsSitofpSext::ConsSitofpSext(std::shared_ptr<TySitofpSext> _sext_sitofp) : sext_sitofp(_sext_sitofp){
}
std::shared_ptr<TyInfrule> ConsSitofpSext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TySitofpSext> _val(new TySitofpSext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TySitofpZext::TySitofpZext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
void TySitofpZext::serialize(cereal::JSONOutputArchive& archive) const{
  archive(CEREAL_NVP(src), CEREAL_NVP(mid), CEREAL_NVP(dst), CEREAL_NVP(srcty), CEREAL_NVP(midty), CEREAL_NVP(dstty));
}

ConsSitofpZext::ConsSitofpZext(std::shared_ptr<TySitofpZext> _sitofp_zext) : sitofp_zext(_sitofp_zext){
}
std::shared_ptr<TyInfrule> ConsSitofpZext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TySitofpZext> _val(new TySitofpZext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyTruncSext::TyTruncSext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
void TyTruncSext::serialize(cereal::JSONOutputArchive& archive) const{
  archive(CEREAL_NVP(src), CEREAL_NVP(mid), CEREAL_NVP(dst), CEREAL_NVP(srcty), CEREAL_NVP(midty), CEREAL_NVP(dstty));
}

ConsTruncSext::ConsTruncSext(std::shared_ptr<TyTruncSext> _trunc_sext) : trunc_sext(_trunc_sext){
}
std::shared_ptr<TyInfrule> ConsTruncSext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyTruncSext> _val(new TyTruncSext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyTruncTrunc::TyTruncTrunc(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
void TyTruncTrunc::serialize(cereal::JSONOutputArchive& archive) const{
  archive(CEREAL_NVP(src), CEREAL_NVP(mid), CEREAL_NVP(dst), CEREAL_NVP(srcty), CEREAL_NVP(midty), CEREAL_NVP(dstty));
}
ConsTruncTrunc::ConsTruncTrunc(std::shared_ptr<TyTruncTrunc> _trunc_trunc) : trunc_trunc(_trunc_trunc){
}
std::shared_ptr<TyInfrule> ConsTruncTrunc::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyTruncTrunc> _val(new TyTruncTrunc(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsTruncZext::ConsTruncZext(std::shared_ptr<TyTruncZext> _trunc_zext) : trunc_zext(_trunc_zext){
}
std::shared_ptr<TyInfrule> ConsTruncZext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyTruncZext> _val(new TyTruncZext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsInttoptrBitcast::ConsInttoptrBitcast(std::shared_ptr<TyInttoptrBitcast> _inttoptr_bitcast) : inttoptr_bitcast(_inttoptr_bitcast){
}
std::shared_ptr<TyInfrule> ConsInttoptrBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyInttoptrBitcast> _val(new TyInttoptrBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyInttoptrPtrtoint::TyInttoptrPtrtoint(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
void TyInttoptrPtrtoint::serialize(cereal::JSONOutputArchive& archive) const{
  archive(CEREAL_NVP(src), CEREAL_NVP(mid), CEREAL_NVP(dst), CEREAL_NVP(srcty), CEREAL_NVP(midty), CEREAL_NVP(dstty));
}

ConsInttoptrPtrtoint::ConsInttoptrPtrtoint(std::shared_ptr<TyInttoptrPtrtoint> _inttoptr_ptrtoint) : inttoptr_ptrtoint(_inttoptr_ptrtoint){
}
std::shared_ptr<TyInfrule> ConsInttoptrPtrtoint::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyInttoptrPtrtoint> _val(new TyInttoptrPtrtoint(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsInttoptrZext::ConsInttoptrZext(std::shared_ptr<TyInttoptrZext> _zext_inttoptr) : zext_inttoptr(_zext_inttoptr){
}
std::shared_ptr<TyInfrule> ConsInttoptrZext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyInttoptrZext> _val(new TyInttoptrZext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TySextBitcast::TySextBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
TySextZext::TySextZext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsSextZext::ConsSextZext(std::shared_ptr<TySextZext> _zext_sext) : zext_sext(_zext_sext){
}
std::shared_ptr<TyInfrule> ConsSextZext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TySextZext> _val(new TySextZext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyUitofpBitcast::TyUitofpBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsUitofpBitcast::ConsUitofpBitcast(std::shared_ptr<TyUitofpBitcast> _uitofp_bitcast) : uitofp_bitcast(_uitofp_bitcast){
}
std::shared_ptr<TyInfrule> ConsUitofpBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyUitofpBitcast> _val(new TyUitofpBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyUitofpZext::TyUitofpZext(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
...
ConsUitofpZext::ConsUitofpZext(std::shared_ptr<TyUitofpZext> _zext_uitofp) : zext_uitofp(_zext_uitofp){
}
std::shared_ptr<TyInfrule> ConsUitofpZext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyUitofpZext> _val(new TyUitofpZext(_src, _mid, _dst, _srcty, _midty, _dstty));
...
TyZextBitcast::TyZextBitcast(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty) : src(_src), mid(_mid), dst(_dst), srcty(_srcty), midty(_midty), dstty(_dstty){
}
void TyZextBitcast::serialize(cereal::JSONOutputArchive& archive) const{
  archive(CEREAL_NVP(src), CEREAL_NVP(mid), CEREAL_NVP(dst), CEREAL_NVP(srcty), CEREAL_NVP(midty), CEREAL_NVP(dstty));
}
ConsZextBitcast::ConsZextBitcast(std::shared_ptr<TyZextBitcast> _zext_bitcast) : zext_bitcast(_zext_bitcast){
}
std::shared_ptr<TyInfrule> ConsZextBitcast::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyZextBitcast> _val(new TyZextBitcast(_src, _mid, _dst, _srcty, _midty, _dstty));
...
ConsZextZext::ConsZextZext(std::shared_ptr<TyZextZext> _zext_zext) : zext_zext(_zext_zext){
}
std::shared_ptr<TyInfrule> ConsZextZext::make(std::shared_ptr<TyValue> _src, std::shared_ptr<TyValue> _mid, std::shared_ptr<TyValue> _dst, std::shared_ptr<TyValueType> _srcty, std::shared_ptr<TyValueType> _midty, std::shared_ptr<TyValueType> _dstty){
  std::shared_ptr<TyZextZext> _val(new TyZextZext(_src, _mid, _dst, _srcty, _midty, _dstty));
