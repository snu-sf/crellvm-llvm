...
TyBitcastptrTgt::TyBitcastptrTgt(std::shared_ptr<TyValue> _v,
                                 std::shared_ptr<TyValue> _vprime,
                                 std::shared_ptr<TyExpr> _bitcastinst)
    : v(std::move(_v)), vprime(std::move(_vprime)),
      bitcastinst(std::move(_bitcastinst)) {}
...
ConsBitcastptrTgt::ConsBitcastptrTgt(
    std::shared_ptr<TyBitcastptrTgt> _bitcastptrtgt)
    : bitcastptrtgt(std::move(_bitcastptrtgt)) {}
std::shared_ptr<TyInfrule>
ConsBitcastptrTgt::make(std::shared_ptr<TyValue> _v,
                        std::shared_ptr<TyValue> _vprime,
                        std::shared_ptr<TyExpr> _bitcastinst) {
  std::shared_ptr<TyBitcastptrTgt> _val(new TyBitcastptrTgt(
      std::move(_v), std::move(_vprime), std::move(_bitcastinst)));
...
TyTransitivityPointerLhs::TyTransitivityPointerLhs(
    ...
    std::shared_ptr<TyValue> _v, std::shared_ptr<TyExpr> _loadq)
    : p(std::move(_p)), q(std::move(_q)), v(std::move(_v)),
      loadq(std::move(_loadq)) {}
...
ConsTransitivityPointerLhs::ConsTransitivityPointerLhs(
    ...
    : transitivity_pointer_lhs(std::move(_transitivity_pointer_lhs)) {}
std::shared_ptr<TyInfrule> ConsTransitivityPointerLhs::make(
    std::shared_ptr<TyValue> _p, std::shared_ptr<TyValue> _q,
    std::shared_ptr<TyValue> _v, std::shared_ptr<TyExpr> _loadq) {
  std::shared_ptr<TyTransitivityPointerLhs> _val(new TyTransitivityPointerLhs(
      std::move(_p), std::move(_q), std::move(_v), std::move(_loadq)));
  return std::shared_ptr<TyInfrule>(
      new ConsTransitivityPointerLhs(std::move(_val)));
}
...
TyTransitivityPointerRhs::TyTransitivityPointerRhs(
    std::shared_ptr<TyValue> _p, std::shared_ptr<TyValue> _q,
    std::shared_ptr<TyValue> _v, std::shared_ptr<TyExpr> _loadp)
    : p(std::move(_p)), q(std::move(_q)), v(std::move(_v)),
      loadp(std::move(_loadp)) {}
...
ConsTransitivityPointerRhs::ConsTransitivityPointerRhs(
    ...
    : transitivity_pointer_rhs(std::move(_transitivity_pointer_rhs)) {}
std::shared_ptr<TyInfrule> ConsTransitivityPointerRhs::make(
    std::shared_ptr<TyValue> _p, std::shared_ptr<TyValue> _q,
    std::shared_ptr<TyValue> _v, std::shared_ptr<TyExpr> _loadp) {
  std::shared_ptr<TyTransitivityPointerRhs> _val(new TyTransitivityPointerRhs(
      std::move(_p), std::move(_q), std::move(_v), std::move(_loadp)));
  return std::shared_ptr<TyInfrule>(
      new ConsTransitivityPointerRhs(std::move(_val)));
}
...
TyIntroGhost::TyIntroGhost(std::shared_ptr<TyValue> _x,
...
std::shared_ptr<TyInfrule>
ConsIntroGhost::make(std::shared_ptr<TyValue> _x,
                     std::shared_ptr<TyRegister> _g) {
