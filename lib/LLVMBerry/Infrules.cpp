...
TyAddOrAnd::TyAddOrAnd(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyValue> _a, std::unique_ptr<TyValue> _b, std::unique_ptr<TyRegister> _x, std::unique_ptr<TyRegister> _y, std::unique_ptr<TySize> _sz) : z(std::move(_z)), a(std::move(_a)), b(std::move(_b)), x(std::move(_x)), y(std::move(_y)), sz(std::move(_sz)){
}
...
ConsAddOrAnd::ConsAddOrAnd(std::unique_ptr<TyAddOrAnd> _add_or_and) : add_or_and(std::move(_add_or_and)){
}
std::unique_ptr<TyInfrule> ConsAddOrAnd::make(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyValue> _a, std::unique_ptr<TyValue> _b, std::unique_ptr<TyRegister> _x, std::unique_ptr<TyRegister> _y, std::unique_ptr<TySize> _sz){
  std::unique_ptr<TyAddOrAnd> _val(new TyAddOrAnd(std::move(_z), std::move(_a), std::move(_b), std::move(_x), std::move(_y), std::move(_sz)));
  return std::unique_ptr<TyInfrule>(new ConsAddOrAnd(std::move(_val)));
}
...
TyAddSextSext::TyAddSextSext(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyRegister> _xprime, std::unique_ptr<TyValue> _x, std::unique_ptr<TyRegister> _yprime, std::unique_ptr<TyValue> _y, std::unique_ptr<TyRegister> _zprime, std::unique_ptr<TySize> _from_sz, std::unique_ptr<TySize> _to_sz) : z(std::move(_z)), xprime(std::move(_xprime)), x(std::move(_x)), yprime(std::move(_yprime)), y(std::move(_y)), zprime(std::move(_zprime)), from_sz(std::move(_from_sz)), to_sz(std::move(_to_sz)){
}
...
ConsAddSextSext::ConsAddSextSext(std::unique_ptr<TyAddSextSext> _add_sext_sext) : add_sext_sext(std::move(_add_sext_sext)){
}
std::unique_ptr<TyInfrule> ConsAddSextSext::make(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyRegister> _xprime, std::unique_ptr<TyValue> _x, std::unique_ptr<TyRegister> _yprime, std::unique_ptr<TyValue> _y, std::unique_ptr<TyRegister> _zprime, std::unique_ptr<TySize> _from_sz, std::unique_ptr<TySize> _to_sz){
  std::unique_ptr<TyAddSextSext> _val(new TyAddSextSext(std::move(_z), std::move(_xprime), std::move(_x), std::move(_yprime), std::move(_y), std::move(_zprime), std::move(_from_sz), std::move(_to_sz)));
  return std::unique_ptr<TyInfrule>(new ConsAddSextSext(std::move(_val)));
}
...
TyAddXorAnd::TyAddXorAnd(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyValue> _a, std::unique_ptr<TyValue> _b, std::unique_ptr<TyRegister> _x, std::unique_ptr<TyRegister> _y, std::unique_ptr<TySize> _sz) : z(std::move(_z)), a(std::move(_a)), b(std::move(_b)), x(std::move(_x)), y(std::move(_y)), sz(std::move(_sz)){
}
...
ConsAddXorAnd::ConsAddXorAnd(std::unique_ptr<TyAddXorAnd> _add_xor_and) : add_xor_and(std::move(_add_xor_and)){
}
std::unique_ptr<TyInfrule> ConsAddXorAnd::make(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyValue> _a, std::unique_ptr<TyValue> _b, std::unique_ptr<TyRegister> _x, std::unique_ptr<TyRegister> _y, std::unique_ptr<TySize> _sz){
  std::unique_ptr<TyAddXorAnd> _val(new TyAddXorAnd(std::move(_z), std::move(_a), std::move(_b), std::move(_x), std::move(_y), std::move(_sz)));
  return std::unique_ptr<TyInfrule>(new ConsAddXorAnd(std::move(_val)));
}
...
TySubOrXor::TySubOrXor(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyValue> _a, std::unique_ptr<TyValue> _b, std::unique_ptr<TyRegister> _x, std::unique_ptr<TyRegister> _y, std::unique_ptr<TySize> _sz) : z(std::move(_z)), a(std::move(_a)), b(std::move(_b)), x(std::move(_x)), y(std::move(_y)), sz(std::move(_sz)){
}
...
ConsSubOrXor::ConsSubOrXor(std::unique_ptr<TySubOrXor> _sub_or_xor) : sub_or_xor(std::move(_sub_or_xor)){
}
std::unique_ptr<TyInfrule> ConsSubOrXor::make(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyValue> _a, std::unique_ptr<TyValue> _b, std::unique_ptr<TyRegister> _x, std::unique_ptr<TyRegister> _y, std::unique_ptr<TySize> _sz){
  std::unique_ptr<TySubOrXor> _val(new TySubOrXor(std::move(_z), std::move(_a), std::move(_b), std::move(_x), std::move(_y), std::move(_sz)));
  return std::unique_ptr<TyInfrule>(new ConsSubOrXor(std::move(_val)));
}
...
TySubSub::TySubSub(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyValue> _x, std::unique_ptr<TyValue> _y, std::unique_ptr<TyValue> _w, std::unique_ptr<TySize> _sz) : z(std::move(_z)), x(std::move(_x)), y(std::move(_y)), w(std::move(_w)), sz(std::move(_sz)){
}
...
ConsSubSub::ConsSubSub(std::unique_ptr<TySubSub> _sub_sub) : sub_sub(std::move(_sub_sub)){
}
std::unique_ptr<TyInfrule> ConsSubSub::make(std::unique_ptr<TyRegister> _z, std::unique_ptr<TyValue> _x, std::unique_ptr<TyValue> _y, std::unique_ptr<TyValue> _w, std::unique_ptr<TySize> _sz){
  std::unique_ptr<TySubSub> _val(new TySubSub(std::move(_z), std::move(_x), std::move(_y), std::move(_w), std::move(_sz)));
  return std::unique_ptr<TyInfrule>(new ConsSubSub(std::move(_val)));
}
